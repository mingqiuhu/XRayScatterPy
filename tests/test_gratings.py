...
class TestGratings(unittest.TestCase):
    ...
    def test_ewald_sphere(self):
        ...
        ewald_sphere_result = gratings.ewald_sphere(
            wavelength, detector_distance, detector_size)
    ...
    def test_reciprocal_space_lattice(self):
        ...
        reciprocal_space_lattice_result = gratings.reciprocal_space_lattice(
            grating_parameters)
    ...
    def test_scattering_pattern_location(self):
        ...
        location = gratings.scattering_pattern_location(
            ewald_sphere, reciprocal_space_lattice)
