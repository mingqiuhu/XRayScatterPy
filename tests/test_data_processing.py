...
class TestDataProcessing(unittest.TestCase):
    ...
    def test_process_data(self):
        ...
        processed_data = data_processing.process_data(raw_data_path, q_calibration, intensity_calibration)
    ...
    def test_calculate_beam_divergence(self):
        beam_divergence = data_processing.calculate_beam_divergence(self.data_2D)
