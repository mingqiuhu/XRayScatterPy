...
class TestModelFitting(unittest.TestCase):
    ...
    def test_example_model_function(self):
        ...
        # Test if the output of the example model function has the expected
        # shape
        self.assertEqual(y.shape, (50,))

    def test_fit_model(self):
        parameters, _ = model_fitting.fit_model(
            self.data, model_fitting.example_model_function, self.initial_parameters)
