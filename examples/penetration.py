...
penetration.analyze_symmetric_penetration(
    1000,
    1.542,
    sld_si['x_real'],
    sld_si['x_imag'],
    [r'$\mathrm{X-ray\ (Cu\ K_{\alpha})\ on\ Si}$'],
    0.2,
    10,
    2e+4,
    0.2,
...
penetration.analyze_symmetric_penetration(
    ...
    7,
    sld_si['neutron_real'],
    sld_si['neutron_incoh'],
    [r'$\mathrm{Neutron\ on\ Si}$'],
    0.2,
    10,
    2e+5,
    0.2,
...
sld_psd8 = nist.get_scattering_parsed(
    "C8D8", "1.12", neutron_wavelength="7 Ang")
penetration.analyze_symmetric_penetration(
    1000,
    7,
    sld_psd8['neutron_real'],
    sld_psd8['neutron_incoh'],
    [r'$\mathrm{Neutron\ on\ PSd8}$'],
    0.1,
    10,
    1e+5,
    0.05,
...
sld_pgm = nist.get_scattering_parsed(
    "C7H12O4", "1.127", neutron_wavelength="7 Ang")
penetration.analyze_symmetric_penetration(
    1000,
    7,
    sld_pgm['neutron_real'],
    sld_pgm['neutron_incoh'],
    [r'$\mathrm{Neutron\ on\ PGM}$'],
    0.1,
    10,
    1e+3,
    0.05,
...
penetration.analyze_symmetric_penetration(
    ...
    0.1,
    0.1)
penetration.analyze_assymetric_penetration(
    1000,
    10.6,
    sld_neutron_real,
    sld_neutron_incoh,
