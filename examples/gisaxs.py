...
qx_array, qy_array, qz_array = calibration.calculate_q(DETX0, params_dict_list, image_array, rho)
...
i_1d_oop = data_processing.calculate_1d_oop(QY_FWHM, Q_MIN, Q_MAX, Q_NUM, qy_array, qz_array, params_dict_list, image_array_rel, omega, index_list=INDEX_LIST)
data_plotting.plot_1d_compare(q_1d_oop, i_1d_oop[0], q_1d_oop, i_1d_oop[3], xscale='linear', xlabel='qz', yunit='a.u.')