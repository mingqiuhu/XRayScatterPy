...
data_plotting.plot_1d(qz_1d, normalized_reflectivity, yunit='normalized reflectivity')
data_plotting.plot_1d_compare(theta_1d, spillover_array, theta_1d, fitted_spillover, xscale='linear', yscale='linear', xlabel='theta sample', ylabel='spill over')
