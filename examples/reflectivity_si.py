...
DATA_PATH = os.path.join(os.path.dirname(__file__), '..', 'data', 'tiff_files_si')
START_INDEX = 55805
END_INDEX = 56006
DETX0 = 100.4
QY_FWHM = 0.1
...
data_plotting.plot_1d(qz_1d[:-5], normalized_reflectivity[:-5], yunit='normalized reflectivity')
