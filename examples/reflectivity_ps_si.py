...
data_plotting.plot_1d_compare(theta_1d, spillover_array, theta_1d, fitted_spillover, 
                              xscale='linear', yscale='linear', xlabel='theta sample', 
                              ylabel='spill over', 
...
np.savetxt('ps_si.txt', np.stack((qz_1d, reflectivity_array), axis=-1))
